    ...
    public class InstructorService
    {
        ...
        private void EditInstructor()
        {
            ...
            instructor.LastName = DataParseHelper.LoadString("ENTER INSTRUCTORS LAST NAME (" + instructor.LastName + ")\n",
                " ENTRY IS REQUIRED\n ");
            instructor.DriverLicenceNumber = DataParseHelper.LoadInteger(" ENTER INSTRUCTORS PILOT LISCENCE NUMBER (" + instructor.PilotLicenceNumber + ")\n",
                " ENTRY IS REQUIRED\n");
        ...
        private void EntryNewInstructor()
        {
            ...
            Instructor.LastName = DataParseHelper.LoadString(" ENTER INSTRUCTORS LAST NAME\n",
                " ENTRY IS REQUIRED\n");
            Instructor.PilotLicenceNumber = DataParseHelper.LoadInteger(" ENTER INSTRUCTORS PILOT LISCENCE NUMBER\n",
                " ENTRY IS REQUIRED\n");

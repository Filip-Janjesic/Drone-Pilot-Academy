...
export default class changeInstructor extends Component {
  ...
  handleSubmit(e) {
    ...
    this.changeInstructor({
      ...
      PILOT_LICENSE_NUMBER: datainfo.get('pilot_LICENSE_NUMBER'),
    ...
    return (
      <Container>
        <Form onSubmit={this.handleSubmit}>
          ...
          <Form.Group className="mb-3" controlId="pilot license number">
            <Form.Label>PILOT_LICENSE_NUMBER</Form.Label>
            <Form.Control type="text" name="pilot license number" placeholder="6546464 "
              defaultValue={instructor.pilot_LICENSE_NUMBER} />
          </Form.Group>
